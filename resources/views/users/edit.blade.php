            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        Name:
                        <br>
                        <input type="text" name="name" value="{{ $user->name }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        <br><br>
                        Email:
                        <br>
                        <input type="text" name="email" value="{{ $user->email }}" class="w-72 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        <br><br>
